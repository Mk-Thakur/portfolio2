...
import project2 from "../Components/SocialLinks/portfoliomk.png"
import project3 from "../Components/SocialLinks/text analyzer ss.png"
import project4 from "../Components/SocialLinks/Screenshot.png"
          ...
          <a href="https://amazing-toffee-71729d.netlify.app">
            ...
            >
              ...
              <div>
                ...
                <h1 className={`text-md font-bold ${bgcolor==="white" ? "text-black" :"text-white"}`}>Adventure Website (HTML,CSS,with responsive)</h1>
              </div>
            </div>
            </a>
          </div>
