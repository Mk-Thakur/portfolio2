...
import Mohit from "./SocialLinks/profile.jpg";
      ...
      <div className="w-full flex justify-around">
        ...
        >
          <div className="w-40 h-40 rounded-full  image">
            <img src={Mohit} className="w-screen rounded-lg" />
          </div>
          <h1
          ...
          <div className=" w-96 p-2 flex gap-2 justify-center relative lg:top-10 sm:top-14">
            ...
            >
              <a href="https://www.instagram.com/mk_thakur_official?igsh=ZmcwN2Z3eWRpc3N6" target="#">
                {" "}
            ...
            >
              <a href="www.linkedin.com/in/mohit-kumar-62b341173">
                {" "}
            ...
            >
              <a href="https://github.com/Mk-Thakur" target="#">
                {" "}
